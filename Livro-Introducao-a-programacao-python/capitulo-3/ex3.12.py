'''
#tempo = input("Digite o tempo da viagem de carro: ")
distancia = input("Digite a distância em km percorrida: ")
velocidade_media = input("Digite a velocidade média em km esperada: ")
tempo_viagem = int(distancia) * int(velocidade_media)
print(f"O tempo desta viagem será de: {tempo_viagem}")
'''
##############################################################################
